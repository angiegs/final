    ...
    <body>
        ...
        <?php 
            ...
            <?php
                ...
                $MetodoPagoCollectorObj-> deleteMetodoPago($metodo);

                echo "<h3 class='topspace text-center'>El metodo de pago <span class='red'>" . $nombremetodo . "</span> ha sido eliminado</h3>";
            ?>
            <div>
