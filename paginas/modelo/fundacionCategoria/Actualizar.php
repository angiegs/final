...
<div id="main">
     ...
     <?php 
                echo '<h2 class="topspace text-center"> Categorías </h2>';
            ?>
...
echo "<h3 class='topspace text-center'>La categoría fundación <span class='green'> " . $id_fundacioncategoria . " </span> ha sido actualizada a <span class='green'> ". $nombre ." <span class='green'> </span></h3>";
?>
